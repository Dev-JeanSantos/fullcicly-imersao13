...
func TestBuyAsset(t *testing.T) {
	...
	investorAssetPosition := NewInvestorAssetPosstion("asset1", 10)
	...
	assert.Equal(5, investor2.GetAssetPossition("asset1").Shares, "Investor 2 should have 5 shares of asset 1")
}
...
func TestBuyAssetWithDifferentAssents(t *testing.T) {
	...
	investorAssetPosition2 := NewInvestorAssetPosstion("asset2", 10)
...
func TestBuyPartialAsset(t *testing.T) {
	...
	investorAssetPosition := NewInvestorAssetPosstion("asset1", 3)
	investor.AddAssetPosition(investorAssetPosition)

	investorAssetPosition2 := NewInvestorAssetPosstion("asset1", 5)
	...
	assert.Equal(3, investor2.GetAssetPossition("asset1").Shares, "Investor 2 should have 3 shares of asset 1")
